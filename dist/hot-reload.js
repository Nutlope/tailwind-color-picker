      ...
      function (require, module, exports) {
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (a = r.createReader()),
                        (e.next = 3),
                        t.toPromise(a.readEntries.bind(a))()
                      );
                    case 3:
                      (o = e.sent), (i = []);
                    case 5:
                ...
                for (;;)
                  switch ((r.prev = r.next)) {
                    case 0:
                      return (
                        (r.next = 2),
                        t.toPromise(chrome.runtime.getPackageDirectoryEntry)()
                      );
                    case 2:
                      return (a = r.sent), (r.next = 5), n(a);
                    case 5:
                      return (
                        (o = r.sent),
                        (i = {}),
                        ...
                        Promise.all(
                          o.map(function (e) {
                            return t
                              .toPromise(e.getMetadata.bind(e))()
                              .then(function (t) {
                                var n = t.modificationTime;
                                i[e.fullPath] = n;
                              });
                          }),
                        )
                                ...
                                for (;;)
                                  switch ((e.prev = e.next)) {
                                    case 0:
                                      return (
                                        (e.next = 2),
                                        t.toPromise(n.getMetadata.bind(n))()
                                      );
                                    case 2:
                                      (r = e.sent),
                                        i[n.fullPath].getTime() !==
                                          r.modificationTime.getTime() &&
        ...
        chrome.management.getSelf(function (e) {
          'development' === e.installType &&
            (console.log(
              'start hot reload at '.concat(new Date().toLocaleString()),
            ),
            r());
        });
      },
