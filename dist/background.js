...
},{}],"../node_modules/inversify-inject-decorators/lib/decorators.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./inversify.config":"common/inversify.config.ts","./message-service":"common/message-service.ts","./utils":"common/utils.ts","./models":"common/models.ts","./content-injector":"common/content-injector.ts"}],"background.ts":[function(require,module,exports) {
"use strict";
...
var common_1 = require("~/common");
var BackgroundMain = /*#__PURE__*/function () {
  function BackgroundMain(messageService, contentInjector) {
    var _this = this;
    _classCallCheck(this, BackgroundMain);
    this.messageService = messageService;
    this.contentInjector = contentInjector;
    this.captureVisibleTab = function () {
      return __awaiter(_this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var tabs, latestTab, zoom, width, height, imgSrc, capturedTab;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
            ...
            case 2:
              ...
              latestTab = tabs[0];
              _context.next = 6;
              return common_1.toPromise(chrome.tabs.getZoom)();
            case 6:
              zoom = _context.sent;
              width = latestTab.width / zoom;
              height = latestTab.height / zoom;
              _context.next = 11;
              return common_1.toPromise(chrome.tabs.captureVisibleTab)(null, {
                format: 'png'
              });
            case 11:
              ...
              return _context.abrupt("return", capturedTab);
            case 15:
            case "end":
              return _context.stop();
          }
  ...
  _createClass(BackgroundMain, [{
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return this.contentInjector.getActiveTabId();
              case 3:
    ...
    value: function handleBrowserAction() {
      var _this3 = this;
      chrome.action.onClicked.addListener(function (_ref) {
        var id = _ref.id;
        _this3.toggleInspector(id);
      });
    }
    /**
     * @remarks
    ...
    key: "toggleInspector",
    value: function toggleInspector(tabId) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return this.contentInjector.inject(tabId);
            case 2:
...
BackgroundMain = __decorate([inversify_1.injectable(), __metadata("design:paramtypes", [typeof (_a = typeof common_1.MessageService !== "undefined" && common_1.MessageService) === "function" ? _a : Object, typeof (_b = typeof common_1.ContentInjector !== "undefined" && common_1.ContentInjector) === "function" ? _b : Object])], BackgroundMain);
common_1.container.bind(BackgroundMain).toSelf();
common_1.container.bind(common_1.ContentInjector).toSelf();
common_1.container.resolve(BackgroundMain);
},{"inversify":"../node_modules/inversify/lib/inversify.js","reflect-metadata":"../node_modules/reflect-metadata/Reflect.js","regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","~/common":"common/index.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
